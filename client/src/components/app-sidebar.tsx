...
import { SquaresFour, Globe, ChartBar, Gear, SignOut, Code, Cookie, FileText, Stethoscope, Buildings, Scroll, Headset } from "@phosphor-icons/react"
...
export function AppSidebar({ user, onLogout }: AppSidebarProps) {
  ...
  const renderNavItem = (item: NavItem) => {
    const isActive =
      location === item.href ||
      (item.href === "/dashboard" && location === "/dashboard/websites");
    return (
    ...
    <Sidebar role="navigation" aria-label="Main navigation">
      ...
      <SidebarContent>
        ...
        <SidebarGroup>
          ...
          <SidebarGroupContent>
            <SidebarMenu>
              {complianceItems.map(renderNavItem)}
            </SidebarMenu>
          </SidebarGroupContent>
        </SidebarGroup>
