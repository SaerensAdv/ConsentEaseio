...
import { Shield, ArrowLeft, Palette, Code, ChartBar, Lightning, Globe, Lock, DeviceMobile, Gear, Check, FileText } from "@phosphor-icons/react";
import { Button } from "@/components/ui/button";

function FeaturesPageSchema() {
  const jsonLd = {
    "@context": "https://schema.org",
    "@type": "WebPage",
    "name": "ConsentEase Features",
    "description": "Discover ConsentEase features: visual banner builder, Google Consent Mode v2, consent analytics, EU data residency, and 2-minute setup. Built for small businesses.",
    "url": "https://consentease.io/features",
    "mainEntity": {
      "@type": "ItemList",
      "name": "ConsentEase Features",
      "description": "Complete list of cookie consent management features",
      "numberOfItems": 8,
      "itemListElement": [
        {
          "@type": "ListItem",
          "position": 1,
          "name": "Visual Banner Builder",
        ...
        },
        {
          ...
          "description": "Your data and your visitors' consent choices are handled with the highest security standards. EU data residency included."
        },
        {
          "@type": "ListItem",
          "position": 7,
...
const features = [
  ...
  },
  {
    ...
    description: "Generate legally compliant Privacy Policies and Cookie Policies with one click. Templates in 8 languages, auto-synced with your cookies.",
    highlights: [
      "GDPR/CCPA compliant templates",
      "8 languages (EN, NL, FR, DE, ES, IT, PT, PL)",
      "One-time purchase: EUR 9/policy or EUR 15 bundle",
      "Up to 100 policies/month included with Agency Pro"
    ]
  }
];

const comparisonData = [
  { feature: "Monthly cost", consentease: "From €7", onetrust: "From $30,000/year" },
...
export default function FeaturesPage() {
  ...
  useEffect(() => {
    ...
    document.title = "Features - Cookie Banner Builder, Analytics & More | ConsentEase";
    if (metaDescription) {
      metaDescription.setAttribute("content", "Discover ConsentEase features: visual banner builder, Google Consent Mode v2, consent analytics, EU data residency, and 2-minute setup. Built for small businesses.");
    }
    if (ogTitle) ogTitle.setAttribute("content", "ConsentEase Features - Everything for Cookie Compliance");
    if (ogDescription) ogDescription.setAttribute("content", "Visual banner builder, Google Consent Mode v2, analytics, and more. 2-minute setup.");
