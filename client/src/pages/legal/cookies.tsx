...
export default function CookiePolicy() {
  ...
  useEffect(() => {
    document.title = "Cookie Policy | ConsentEase";
    
    const metaDescription = document.querySelector('meta[name="description"]');
    if (metaDescription) metaDescription.setAttribute('content', 'Read the ConsentEase Cookie Policy. Learn about the cookies we use, their purposes, and how to manage your cookie preferences on our consent management platform.');
    
    const ogTitle = document.querySelector('meta[property="og:title"]');
    if (ogTitle) ogTitle.setAttribute('content', 'Cookie Policy | ConsentEase');
    
    const ogDescription = document.querySelector('meta[property="og:description"]');
    if (ogDescription) ogDescription.setAttribute('content', 'Read the ConsentEase Cookie Policy. Learn about the cookies we use, their purposes, and how to manage your cookie preferences on our consent management platform.');
    ...
    if (twitterTitle) twitterTitle.setAttribute('content', 'Cookie Policy | ConsentEase');
    
    const twitterDescription = document.querySelector('meta[name="twitter:description"]');
    if (twitterDescription) twitterDescription.setAttribute('content', 'Read the ConsentEase Cookie Policy. Learn about the cookies we use, their purposes, and how to manage your cookie preferences on our consent management platform.');
